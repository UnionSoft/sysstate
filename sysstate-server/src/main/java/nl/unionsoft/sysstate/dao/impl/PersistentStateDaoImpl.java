...
@Service("persistentStateDaoImpl")
@Transactional(readOnly = false, propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
public class PersistentStateDaoImpl implements StateDao {
    private static final Logger LOG = LoggerFactory.getLogger(PersistentStateDaoImpl.class);
    ...
    public void cleanStatesOlderThanDays(int maxDaysToKeepStates) {
        ...
        // @formatter:off
        final int removed = entityManager.createQuery("DELETE FROM State " +
